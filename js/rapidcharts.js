...
function lineGraph3(data, id) {
    ...
    for (var i in data) {
        ...
        // due to reasons, note the discrepancy between name and data

		allData["positive"].push(data[i].positive + data[i].negative + data[i].invalid);
		allData["negative"].push(data[i].positive);
		allData["invalid"].push(data[i].negative);
        allData["positivity"].push(data[i].positive / (data[i].positive + data[i].negative + data[i].invalid));
    }
...
function lineGraph4(data, id) {
    ...
    for (var i in data) {
        ...
        allData["positivity"].push(data[i].positive / (data[i].positive + data[i].negative + data[i].invalid) * 100);
    }
